...
const Notification = ({ content }) => {
  ...
  return <Alert severity='success'>{content}</Alert>
}
...
const Menu = () => {
  ...
  return (
    <AppBar position='static'>
      <Toolbar>
        <IconButton edge='start' color='inherit' aira-label='menu' />
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          <TextField label='content' {...contentField} />
        </div>
        <div>
          <TextField label='author' {...authorField} />
        </div>
        <div>
          <TextField label='info' {...infoField} />
        </div>
